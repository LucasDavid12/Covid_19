...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    actionButton("amba", "AMBA", icon = icon("search-plus")),
    actionButton("nor", "Región Norte", icon = icon("search-plus")),
    actionButton("centro", "Región Centro", icon = icon("search-plus")), 
    actionButton("sur", "Región Sur", icon = icon("search-plus")),
